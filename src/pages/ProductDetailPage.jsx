        ...
        <div className="flex flex-col lg:flex-row lg:space-x-16">
          ...
          <div className="w-full lg:w-3/5 space-y-4">
             <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="aspect-[3/4] bg-gray-50 overflow-hidden relative group cursor-zoom-in">
                ...
                <div className="aspect-[3/4] bg-gray-100 flex items-center justify-center p-8 text-center border-2 border-dashed border-gray-200">
                   <div>
                     <Star size={32} className="mx-auto mb-2 text-gray-300" />
                     <p className="text-[10px] font-black text-gray-400 tracking-widest">MORE SHOTS COMING SOON</p>
                   </div>
                </div>
             </div>
          </div>
