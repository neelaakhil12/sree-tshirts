        ...
        <div className="container mx-auto grid grid-cols-1 md:grid-cols-2 gap-20 items-center">
           ...
           <div className="space-y-8" data-aos="fade-left">
              ...
              <div className="space-y-6 text-gray-600 text-lg leading-relaxed">
                 <p>
                    Founded in the heart of Nandyal and Bangalore that fashion should be a perfect blend of style and ease. Under the visionary leadership of <span className="font-black text-black">VENKATA SIVA CM</span>, our journey began as a dedicated local store and has now evolved into Wear Mingle a dynamic online destination for the modern wardrobe.
                 </p>
                 <p>
